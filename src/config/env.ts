...
const envSchema = z.object({
  ...
  COLLECTOR_REDBUS: z.string().optional().default(''),
  BRIGHTDATA_TIMEOUT_MS: z.coerce.number().int().positive().default(900_000),
  BRIGHTDATA_POLL_INTERVAL_MS: z.coerce.number().int().positive().default(5_000),
